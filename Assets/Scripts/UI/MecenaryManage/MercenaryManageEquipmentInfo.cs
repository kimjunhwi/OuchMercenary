...
public class MercenaryManageEquipmentInfo : ToggleUIBase 
{
	...
	public void CreateCharacterSlot(E_PREPAREBATTLE_CHARCTERTYPE _typeIndex,  RectTransform listRectTransform)
	{
		...
		for (int i = 0; i < 24; i++) {		
			GameObject cSlot_Obj = equipMentSlotPool.GetObject ();
